...
void DrawWidget::drawShape(const QPointF ptStart,const QPointF ptEnd,const ST::ShapeType drawType)
{
   ...
   QPen pen;
    ...
    case ST::Diamond:{
           ...
           QPointF point11(ptEnd.x(),(ptStart.y()+ptEnd.y())/2);
           QPointF point22((ptStart.x()+ptEnd.x())/2,ptStart.y());
           QPointF point33(ptStart.x(),(ptStart.y()+ptEnd.y())/2);
           QPointF point44((ptStart.x()+ptEnd.x())/2,ptEnd.y());
